...
import GalleryGipswanden from "../components/GalleryGipswanden";

export default function gipswanden() {
        ...
        <div className="max-w-7xl mx-auto px-4 space-y-8 sm:px-6 lg:px-8">
          ...
          <div className="relative z-10 text-base max-w-prose mx-auto lg:max-w-5xl lg:mx-0 lg:pr-72">
            <p className="text-lg text-gray-500">
              Er zijn vele verschillende soorten gipswanden mogelijk. Zo kan
              iedere denkbare kleur gebruikt worden. Er zijn verschillende
              soorten reliëf mogelijk die in combinatie met kleurgebruik elk
              voor een apart uiterlijk en sfeer in het huis zorgen.
            </p>
          ...
          <div className="lg:grid lg:grid-cols-2 lg:gap-8 lg:items-start">
            <div className="relative z-10">
              <div className="prose prose-red text-gray-500 mx-auto lg:max-w-none">
                ...
                <p className="text-lg text-gray-500 mb-3">
                  Soorten gipswanden als spachtelputz, granol, marmerpleister en
                  rustiekputz hebben een korrelige structuur die veroorzaakt
                  wordt door toevoeging van zandkorrels en/of kleine steentjes.
                </p>
                <p className="text-lg text-gray-500 mb-3">
                  Door deze toevoeging ontstaat er reliëf in het gipswanden. Ook
                  deze soorten gipswanden zijn in iedere kleur leverbaar.
                </p>{" "}
                <p className="text-lg text-gray-500 mb-3">
                ...
                <p className="text-lg text-gray-500 mb-3">
                  ...
                  gipswanden juist zo glad mogelijk gemaakt wordt. Soms wordt er
                  ook olie gebruikt om deze muren af te werken en is het
                  stukwerk geschikt voor vochtige ruimtes zoals in de badkamer.
                </p>
                <p className="text-lg text-gray-500 mb-3">
                  Benamingen van dit soort typen gipswanden verschillen nogal.
