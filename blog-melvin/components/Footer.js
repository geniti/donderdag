              ...
              <div className="md:grid md:grid-cols-2 md:gap-8">
                <div>
                  ...
                  <ul className="mt-4 space-y-4">
                    ...
                    <Link href="/stucwerk#pleisterwerk">
                      <li>
                        <a className="text-base text-gray-500 hover:text-gray-900">
                          Pleisterwerk
                        </a>
                    ...
                    <Link href="/stucwerk#sierpleister">
                      <li>
                        <a className="text-base text-gray-500 hover:text-gray-900">
                          Sierpleister
                        </a>
                    ...
                    <Link href="/stucwerk#lijstenenornamenten">
                      <li>
                        <a className="text-base text-gray-500 hover:text-gray-900">
